            ...
            <>
              {user ? (
                <>
                  ...
                  <NavLink
                    to="/profile"
                    className="bg-gradient-to-r from-slate-700 to-slate-600 px-4 py-3 rounded-lg flex items-center gap-3 hover:from-slate-600 hover:to-slate-500 transition-all duration-300"
                  ...
                  <button
                    onClick={handleLogout}
                    className="mt-4 text-red-400 hover:text-red-300 font-medium transition-all duration-300 hover:scale-105"
                  >
                    Logout
                  </button>
                </>
                ...
                <>
                  ...
                  <NavLink
                    to="/register"
                    className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-3 rounded-lg text-center text-white font-semibold hover:from-indigo-500 hover:to-purple-500 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105"
                    onClick={() => setMenuOpen(false)}
                  >
                    Sign Up
                  </NavLink>
