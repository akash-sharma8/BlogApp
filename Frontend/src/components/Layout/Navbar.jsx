...
export default function Navbar() {
  ...
  const buttonStyle = "px-3 py-2 rounded-md text-sm font-medium transition-colors duration-300 text-slate-300 hover:text-white bg-transparent hover:bg-slate-700";
  return (
